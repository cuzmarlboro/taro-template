 ...
 * @LastEditTime: 2025-04-13 02:14:39
 * @FilePath: /taro-template/config/ios.js
 * @Description:
 *
...
export default {
  mini: {},
  h5: {
    publicPath: DEPLOY_CONFIG[IOS].publicPath, // 项目产出路径
    outputRoot: DEPLOY_CONFIG[IOS].outputRoot, // 项目产出目录
    webpackChain(chain) {
