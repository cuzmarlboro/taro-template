 ...
 * @LastEditTime: 2025-04-13 02:13:55
 * @FilePath: /taro-template/config/android.test.js
 * @Description:
 *
...
export default {
  mini: {},
  h5: {
    publicPath: DEPLOY_CONFIG[ANDROID_TEST].publicPath, // 项目产出路径
    outputRoot: DEPLOY_CONFIG[ANDROID_TEST].outputRoot, // 项目产出目录
    webpackChain(chain) {
